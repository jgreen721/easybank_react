      ...
      <div className="footer-left-col">
        <div className="footer-col">
          ...
          <ul className="social-media-links">
            {mediaLinks.map((l) => (
              <li className="social-media-item" key={l.id}>
                {l.image}
              </li>
            ))}
          </ul>
        ...
        <div className="footer-col">
          <div className="site-links-grid">
            {siteLinks.map((s) => (
              <li className="site-item" key={s.id}>
                {s.name}
              </li>
            ))}
          </div>
      ...
      <div className="footer-right-col">
        <div className="footer-col">
          <div className="footer-content">
            <button className="btn footer-invite-btn">Request Invite</button>
            <h5 className="muted">@Easybank All Rights Reserved</h5>
          </div>
        </div>
      </div>
    </div>
